...
#'   get, those things shouldn't really matter that much but I want to include them anyways. At realistic deck sizes,
#'   they don't cost much.
#'
#' @param round a data frame with a row for each player in the hand. Though not required I include a hand ID and a player
...
#'                decks.
#'
#' @return a data frame with the original round input plus unique pocket cards for each row and community cards that are
