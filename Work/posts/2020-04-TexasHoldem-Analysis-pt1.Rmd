...
```{r setup, cache = TRUE, include = FALSE, warning = FALSE, cache.lazy = FALSE}
# Location
print(getwd())
if (!any(grepl("data-raw", list.files()))) {
  knitr::opts_knit$set(root.dir = "~/Desktop/Miscellaneous/Data Blog/TexasHoldEm")
  setwd("../..")
}
print(getwd())
# Libraries Needed
